...
function Player:init(map)
    ...
    self.behaviors = {
        ...
        -- Check if gewonnen
            if self.map:WinCollides(self.map:tileAt(self.map.mapWidth - 2, self.map.mapHeight/2 - 1)) or
            self.map:WinCollides(self.map:tileAt(self.map.mapWidth - 2, self.map.mapHeight/2 - 2)) or 
            self.map:WinCollides(self.map:tileAt(self.map.mapWidth - 2, self.map.mapHeight/2 - 3)) or
            self.map:WinCollides(self.map:tileAt(self.map.mapWidth - 1, self.map.mapHeight/2 - 3)) then
                self.map.gamestate = 'WON'
            end
